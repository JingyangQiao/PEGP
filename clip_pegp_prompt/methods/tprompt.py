...
class TPrompts(BaseLearner):
    ...
    def _train(self, train_loader, test_loader):
        ...
        # Save Checkpoints
        weights = self._network.state_dict()

        # 保存权重到文件
        torch.save(weights, 'outputs/model_weights_task_' + str(self._cur_task) +'.pth')
        ...
        sum_ = rep + p_
        self.feature = memory.update_memory(sum_, 0.90, self.feature)
